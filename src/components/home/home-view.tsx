...
export function HomeView({ updates }: { updates: AppUpdate[] }) {
  ...
  const handleFeedbackSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setSendError(
        error instanceof Error ? error.message : t("home.feedbackModal.error")
      );
    } finally {
      setSending(false);
    }
              ...
              <form onSubmit={handleFeedbackSubmit}>
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  >
                    ...
                    {sending
                      ? t("home.feedbackModal.sending")
                      : t("home.feedbackModal.send")}
                  </button>
                </div>
              </form>
            )}
